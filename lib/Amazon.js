            ...
            if (Object.keys(productJsonMeta.colorToAsin).length) {
                for (let item in productJsonMeta.colorToAsin) {
                    ...
                    const variant = {
                        ...
                        images: images,
                        title: item,
                        link: `https://www.amazon.co.uk/dp/${productJsonMeta.colorToAsin[item].asin}/?th=1&psc=1`,
            ...
            try {
                for (let item of variantsSelector[0].children) {
                    ...
                    variants.push({
                        ...
                        link: `https://www.amazon.co.uk/dp/${variant.asin}/?th=1&psc=1`,
    ...
    extractAlsoBought($) {
        ...
        for (let item of bought[0].children[0].children) {
            ...
            try {
                ...
                product.url = `https://www.amazon.co.uk/dp/${product.asin}/?th=1&psc=1`;
            } catch {
                // continue regardless of error
            }
    ...
    extractImages($, body) {
        ...
        if (!images.length) {
            ...
            if (imageData) {
                ...
                if (imageIdregex) {
                    images.push(`https://images-na.ssl-images-amazon.co.uk/images/I/${imageIdregex[1]}.jpg`);
                }
            }
        }
